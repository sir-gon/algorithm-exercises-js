...
function problem0004(_DEBUG = false) {
  let i;
  let j;
  let foundi;
  let foundj;
  ...
  do {
      ...
      do {
          ...
          if( isPalindrome( j * i ) )
          {
              ...
              // if (_DEBUG) console.log(`FOUND: ${i} x ${j} = ${j * i} is NOT Palindrome`);
          }
  ...
  if (_DEBUG) console.log(`Largest Palindrome => ${foundi} 𝗑 ${foundj} = ${foundPalindrome}`);
